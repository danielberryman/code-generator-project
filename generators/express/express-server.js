    ...
    actions: [
      {
        ...
        templateFile: `${process.env.HOME}/Code/db-plop/templates/express/express-server.hbs`,
      },
      {
        type: "add",
        path: `${process.env.HOME}/Code/db-plop/output/express/routes.ts`,
        templateFile: `${process.env.HOME}/Code/db-plop/templates/express/express-routes.hbs`,
      },
    ],
  });
};
